...
year_month_state_massshooting %>% 
  ...
  count() %>% 
  rename(number_mass_shooting=n) %>% 
  ggplot(aes(year_month,number_mass_shooting)) +

  geom_xspline(aes(group=1),color="lightblue",size=0.7) + geom_point(color="lightblue",size=2) +
  ...
  labs(x = "Month Year ", y = "Mass Shooting", title = "Mass shooting in US from \n January 2018 to October 2021",caption="Source:www.gunviolencearchive.org",tag="B") + theme(plot.background = element_rect(colour = "lightblue", size = 3, linetype = 1, 
    fill = "white"), plot.title = element_text(colour = "black", face = "bold", 
    size = 14, vjust = 3, hjust = 0.5), plot.margin = unit(c(0.2, 0.2, 0.2, 0.2), "inches"),axis.text=element_text(colour="black")) + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust =1)) 
...
mass_shooting_state %>% 
  ggplot(aes(x=fct_reorder(state,number_mass_shooting),y=number_mass_shooting,fill=Number)) + geom_bar(stat = "identity", colour = "black",position = "dodge") +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust =1))+ labs(y= "Mass Shooting", x = "State",title="Massing shooting in 48 states of US",caption="Source:www.gunviolencearchive.org",tag="C") +
  
  theme(plot.background = element_rect(colour = "yellow", size = 3, linetype = 1, 
  fill = "white"), plot.title = element_text(colour = "black", face = "bold", 
  size = 18, vjust = 3, hjust = 0.5), plot.margin = unit(c(0.2, 0.2, 0.2, 0.2), "inches"),axis.text=element_text(colour="black",size=6)) + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust =1)) 
```
