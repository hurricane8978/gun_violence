...
“2020 was the deadliest gun violence year in decades. So far, 2021 is worse” from The Washington Post
(https://www.washingtonpost.com/nation/2021/06/14/2021-gun-violence/)

“Shootings never stopped during the pandemic: 2020 was the deadliest gun violence year in decades” from The Washington Post
(https://www.washingtonpost.com/nation/2021/03/23/2020-shootings/)

“Surging COVID-19 cases threaten to send NYC and US economy into second tailspin” from Nydailynews
(https://www.nydailynews.com/coronavirus/ny-coronavirus-unemployment-pandemic-case-rate-20201112-u577rg47bjbhlgaqcgyjjj5xtq-story.html)

“Suspect Charged in Death of University of Chicago Student” from USNEWS
(https://www.usnews.com/news/us/articles/2021-11-12/slaying-of-chinese-student-in-chicago-spurs-call-for-action)
...
1.National Mass Shooting Dataset
...
year
state
number_killed: number of killed in a mass shooting incident
number_injuried: number of injuried in a mass shooting incident
number_year_killed: total number of killed in a specific state  in a year
number_year_injuried: total number of injuried in a specific state  in a year
...
2. NY Shooting Incidents Dataset
...
Data cleaning:
In general, we delete the incident id and coordinate data.


3.Unemployment rate Dataset
...
series_id: the number id of each state.
year
period: the number of month in a year
label: the year and month of our unemployment rate
value: the unemployment rate of each state
