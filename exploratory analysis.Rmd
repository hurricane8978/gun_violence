...
UNRATE %>% 
  ...
  xlab("Time")+
  labs(title = " Unemployment Rate in US from 2018 to 2021",caption="(Source:https://www.bls.gov/)")+
...
fig + theme( plot.title = element_text(colour = "black", face = "bold", 
    size = 20, vjust = 3, hjust = 0.5), plot.margin = unit(c(0.2, 0.2, 0.2, 0.2), "inches"),axis.text=element_text(colour="black",size=11),axis.title=element_text(size=15)) + theme(plot.caption = element_text(size=7)) +labs(caption="(Source:https://www.bls.gov/)")
```
